...
public class AltCreatorGUI extends GuiScreen
{
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.emailField.getText().equals("") && !this.emailField.isFocused()) {
			this.fontRenderer.drawStringWithShadow("Email", this.width / 2f - 97, this.height / 2f - 96, 0xFF999999);
		}

		if (this.passField.getText().equals("") && !this.passField.isFocused()) {
			this.fontRenderer.drawStringWithShadow("Password", this.width / 2f - 97, this.height / 2f - 76, 0xFF999999);
		}
