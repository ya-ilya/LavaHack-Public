...
public class Window {
    ...
    public void render(IRenderer renderer, int mouseX, int mouseY) {
        ...
        if (Config.instance.guiGlow.getValBoolean()) Render2DUtil.drawRoundedRect(x / 2.0, y / 2.0, (x + width) / 2.0, (y + headerHeight) / 2.0, SECONDARY_FOREGROUND, Config.instance.glowBoxSize.getValDouble());
