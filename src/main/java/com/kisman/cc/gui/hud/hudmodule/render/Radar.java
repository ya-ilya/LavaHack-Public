...
public class Radar extends HudModule {
    ...
    public void onRender(RenderGameOverlayEvent.Text event) {
        ...
        //draw crosshair
        Render2DUtil.drawRect(150 / 2.0 - 0.5 + x, 3 + CustomFontUtil.getFontHeight() + y, 150 / 2.0 + 0.5 + x, 150 - 3 - CustomFontUtil.getFontHeight() + y, new Colour(50, 50, 50, 165).getRGB());
        Render2DUtil.drawRect(3 + CustomFontUtil.getStringWidth(directions[3]) + x, 150 / 2.0 - 0.5 + y, 150 - 3 - CustomFontUtil.getStringWidth(directions[1]) + x, 150 / 2.0 + 0.5 + y, new Colour(50, 50, 50, 165).getRGB());
        ...
        if (isNorth) Render2DUtil.drawRect(150 / 2.0 - 0.5 - 6 + x, 150 / 2.0 - 0.5 + y, 150 / 2.0 - 0.5 + x, 150 / 2.0 + 0.5 + y, color);
        else if (isSouth) Render2DUtil.drawRect(150 / 2.0 + 0.5 + x, 150 / 2.0 - 0.5 + y, 150 / 2.0 + 0.5 + 6 + x, 150 / 2.0 - 0.5 + y, color);
        else if (isEast) Render2DUtil.drawRect(150 / 2.0 - 0.5 + x, 150 / 2.0 - 0.5 - 6 + y, 150 / 2.0 + 0.5 + x, 150 / 2.0 - 0.5 + y, color);
        else if (isWest) Render2DUtil.drawRect(150 / 2.0 - 0.5 + x, 150 / 2.0 + 0.5 + y, 150 / 2.0 + 0.5 + x, 150 / 2.0 + 0.5 + 6 + y, color);


        //draw direction's names
        CustomFontUtil.drawStringWithShadow(directions[0], 150 / 2.0 - (CustomFontUtil.getStringWidth(directions[0]) / 2.0) + x, 2 + y, color);
        CustomFontUtil.drawStringWithShadow(directions[2], 150 / 2.0 - (CustomFontUtil.getStringWidth(directions[2]) / 2.0) + x, 150 - 2 - CustomFontUtil.getFontHeight() + y, color);
        CustomFontUtil.drawStringWithShadow(directions[1], 2 + x, 150 / 2.0 - CustomFontUtil.getFontHeight() / 2.0 + y, color);
        CustomFontUtil.drawStringWithShadow(directions[3], 150 - 2 - CustomFontUtil.getStringWidth(directions[3]) + x, 150 / 2.0 - CustomFontUtil.getFontHeight() / 2.0 + y, color);
    ...
    private void renderEntityPoint(Entity entity) {
        ...
        Render2DUtil.drawRect(150 / 2.0 + distanceX + x - 0.5, 150 / 2.0 + distanceY + y - 1.5, 150 / 2.0 + distanceX + x + 0.5, 150 / 2.0 + distanceY + y + 1.5, color);
        Render2DUtil.drawRect(150 / 2.0 + distanceX + x - 1.5, 150 / 2.0 + distanceY + y - 0.5, 150 / 2.0 + distanceX + x + 1.5, 150 / 2.0 + distanceY + y + 0.5, color);
    }
