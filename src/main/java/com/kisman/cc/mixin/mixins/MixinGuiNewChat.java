...
import com.kisman.cc.module.chat.ChatModifier;
...
public class MixinGuiNewChat {
    ...
    private void printChatMessageWithOptionalDeletionHook(final CallbackInfo ci) {
    ...
    @ModifyVariable(method = "getChatComponent", at = @At(value = "STORE", ordinal = 0), ordinal = 1, argsOnly = true)
