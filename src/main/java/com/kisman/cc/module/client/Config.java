...
public class Config extends Module {
    ...
    public Config() {
        ...
        settingManager.register(nameMode);
        settingManager.register(customName);
        settingManager.register(scrollSpeed);
        settingManager.register(horizontalScroll);
        settingManager.register(keyForHorizontalScroll);
        settingManager.register(guiGlow);
        settingManager.register(glowOffset);
        settingManager.register(glowRadius);
        settingManager.register(glowBoxSize);
        settingManager.register(guiGradient);
        settingManager.register(guiGradientDiff);
        settingManager.register(guiDesc);
        settingManager.register(guiParticles);
        settingManager.register(guiOutline);
        settingManager.register(guiAstolfo);
        settingManager.register(guiRenderSize);
        settingManager.register(guiBetterCheckBox);
        settingManager.register(guiBlur);
        settingManager.register(guiVisualPreview);
        settingManager.register(guiShowBinds);
        settingManager.register(pulseMin);
        settingManager.register(pulseMax);
        settingManager.register(pulseSpeed);
        settingManager.register(saveConfig);
        settingManager.register(loadConfig);
        settingManager.register(configurate);
        settingManager.register(particlesColor);
        settingManager.register(particlesGradientMode);
        settingManager.register(particlesGStartColor);
        settingManager.register(particlesGEndColor);
        settingManager.register(particlesWidth);
        settingManager.register(particleTest);
        settingManager.register(slowRender);
        settingManager.register(depthFix);
        settingManager.register(antiOpenGLCrash);
